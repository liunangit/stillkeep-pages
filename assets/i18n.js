const translations = {
  "zh-Hans": {
    ...
    homeEyebrow: "个人物品记录",
    homeTitle: "留物",
    homeLead: "一款安静的个人物品记录工具，帮你看清正在拥有的东西、它们随时间变化的持有成本，以及那些需要先放一放的想买念头。",
    homePrivacyAction: "查看隐私政策",
    homeSupportAction: "获取技术支持",
    homeAppStoreAction: "前往 App Store 下载",
    homeLearnAction: "了解功能",
    homeHeroNote: "为想减少冲动、让拥有变得更清楚的人设计。",
    featuresEyebrow: "为什么用留物",
    featuresTitle: "看清留下来的东西，也给下一次购买一点距离。",
    featureInventoryTitle: "清爽的物品清单",
    featureInventoryBody: "记录名称、分类、价格、日期、备注、照片和喜爱评分，但不把生活变成表格。",
    featureWishlistTitle: "更冷静的想买清单",
    featureWishlistBody: "把想买的东西先放进冷静期，等冲动退去后再决定是否购买。",
    featureStatsTitle: "能被感知的持有成本",
    featureStatsBody: "查看总成本、日均成本、分类分布和真正值得留下的物品。",
    screensEyebrow: "应用内体验",
    screensTitle: "为日常决定准备的安静工具。",
    downloadEyebrow: "下载",
    downloadTitle: "从一件值得留下的东西开始。",
    downloadBody: "点击 App Store 链接，或通过分享卡片上的二维码打开下载页面。",
    downloadQrCaption: "扫码打开 App Store 页面。",
    privacyEyebrow: "隐私政策",
    privacyTitle: "隐私政策",
  ...
  en: {
    ...
    homeEyebrow: "Personal inventory",
    homeTitle: "Stillkeep",
    homeLead: "A calm personal inventory app for tracking what you own, what each item costs over time, and what you are thinking about buying.",
    homePrivacyAction: "View Privacy Policy",
    homeSupportAction: "Get Support",
    homeAppStoreAction: "Download on the App Store",
    homeLearnAction: "Explore features",
    homeHeroNote: "Built for people who want fewer impulses and clearer ownership.",
    featuresEyebrow: "Why Stillkeep",
    featuresTitle: "See what stays. Pause before what comes next.",
    featureInventoryTitle: "Inventory that stays readable",
    featureInventoryBody: "Record names, categories, prices, dates, notes, photos, and favorite ratings without turning life into a spreadsheet.",
    featureWishlistTitle: "A calmer wishlist",
    featureWishlistBody: "Put potential purchases through a cooling-off period so you can decide with less urgency.",
    featureStatsTitle: "Costs you can feel",
    featureStatsBody: "Review holding cost, daily cost, category distribution, and the items that still earn their place.",
    screensEyebrow: "Inside the app",
    screensTitle: "Quiet tools for everyday decisions.",
    downloadEyebrow: "Download",
    downloadTitle: "Start with one thing worth keeping.",
    downloadBody: "Open the App Store link or scan the QR code from a share card to install Stillkeep.",
    downloadQrCaption: "Scan to open the App Store page.",
  ...
  ja: {
    ...
    homeEyebrow: "持ち物の記録",
    homeTitle: "持ちもの帖",
    homeLead: "持っている物、時間とともに変わる持有コスト、そして一度置いて考えたい買い物を静かに整理するアプリです。",
    homePrivacyAction: "プライバシーポリシー",
    homeSupportAction: "サポートを見る",
    homeAppStoreAction: "App Store でダウンロード",
    homeLearnAction: "機能を見る",
    homeHeroNote: "衝動を減らし、持ち物をよりはっきり見たい人のために。",
    featuresEyebrow: "持ちもの帖の特徴",
    featuresTitle: "残すものを見つめ、次の買い物に少し余白を。",
    featureInventoryTitle: "読みやすい持ち物リスト",
    featureInventoryBody: "名前、カテゴリ、価格、日付、メモ、写真、評価を、生活を表計算にせず記録できます。",
    featureWishlistTitle: "落ち着いて考える欲しい物リスト",
    featureWishlistBody: "欲しい物を冷却期間に置き、急がずに購入を判断できます。",
    featureStatsTitle: "実感できる持有コスト",
    featureStatsBody: "総コスト、日平均コスト、カテゴリ分布、残す価値のある物を確認できます。",
    screensEyebrow: "アプリ画面",
    screensTitle: "日々の判断を支える静かな道具。",
    downloadEyebrow: "ダウンロード",
    downloadTitle: "残したい一つから始めましょう。",
    downloadBody: "App Store リンクを開くか、共有カードの QR コードを読み取ってダウンロードできます。",
    downloadQrCaption: "読み取ると App Store ページが開きます。",
